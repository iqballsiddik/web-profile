 <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{ route('admin.index') }}">Portfolio</a>
            </div>
            <!-- /.navbar-header -->
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="{{ route('master.portfolio') }}">Portfolio</a>
                                </li>
                                <li>
                                    <a href="{{ route('master.about') }}">About</a>
                                </li>
                                <li>
                                    <a href="{{ route('master.contact') }}">Contact</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
